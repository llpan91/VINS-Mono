...
void PoseGraph::loadPoseGraph() {
  ...
  if (pFile == NULL) {
    printf(
        ...
        "system will start with new pose graph \n");
    return;
  }
  int index;
  double time_stamp;
  ...
  int cnt = 0;
  while (fscanf(pFile,
                "%d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %lf %lf %lf %lf %lf %lf "
                "%lf %lf %d",
                ...
                &keypoints_num) != EOF) {
    /*
    printf("I read: %d %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %d %lf %lf %lf %lf %lf %lf
    %lf %lf %d\n", index, time_stamp,
