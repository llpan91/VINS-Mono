...
// equal the function cv::triangulatePoints;
...
// equal to solvePnp, just add some interface for struct "SFMFeature";
    ...
    */
    ...
    for (int i = 0; i < feature_num; i++) {
        ...
        for (int j = 0; j < int(sfm_f[i].observation.size()); j++) {
            ...
            // NULL => don't use kernal function
            // c_rotation[l], c_translation[l], sfm_f[i].position is parameters to be optimized
    ...
    for (int i = 0; i < frame_num; i++) {
        ...
        q[i] = q[i].inverse();
        // cout << "final  q" << " i " << i <<"  " <<q[i].w() << "  " << q[i].vec().transpose() <<
        // endl;
    }
    for (int i = 0; i < frame_num; i++) {
        ...
        // cout << "final  t" << " i " << i <<"  " << T[i](0) <<"  "<< T[i](1) <<"  "<< T[i](2) <<
        // endl;
    }
